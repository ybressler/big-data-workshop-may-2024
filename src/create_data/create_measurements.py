# -*- coding: utf-8 -*-
"""
Shamelessly copies from https://github.com/ifnesi/1brc/blob/main/createMeasurements.py
"""
...
class CreateMeasurement:
    ...
    def generate_batch(self, std_dev: float = 10, records: int = 10_000_000) -> pl.DataFrame:
        batch = self.stations.sample(
            records, with_replacement=True, shuffle=True, seed=self.rng.integers(np.iinfo(np.int64).max)
        )
